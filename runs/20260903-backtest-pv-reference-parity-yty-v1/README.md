...
| Field | Value |
|---|---|
| Run ID | `20260903-backtest-pv-reference-parity-yty-v1` |
| Product | Backtest |
| Study | `N/A` |
| Experiment | `N/A` |
| Period | 2020 ~ 2026 |
...
- [Public Report](https://comus93.github.io/portfolio-optimizer-kr/runs/20260903-backtest-pv-reference-parity-yty-v1/report.html)
- [Report](report.html)
- [Input](input.yaml)
- [Result](result.json)
- [Raw tables](raw/)
