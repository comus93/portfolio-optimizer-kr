...
| Field | Value |
|---|---|
| Run ID | `20260903-backtest-pv-reference-parity-yty-v7` |
| Product | Backtest |
| Study | `N/A` |
| Experiment | `N/A` |
| Period | 2020 ~ 2026 |
...
Historical comparison of Sample Portfolio, Portfolio 2, Portfolio 3 against State Street SPDR S&P 500 ETF Trust (SPY).
...
- [Public Report](https://comus93.github.io/portfolio-optimizer-kr/runs/20260903-backtest-pv-reference-parity-yty-v7/report.html)
- [Report](report.html)
- [Input](input.yaml)
- [Result](result.json)
- [Raw tables](raw/)
