...
| Field | Value |
|---|---|
| Run ID | `20260914-0001` |
| Product | Optimization |
| Study | `provided-portfolio-v1-optimization` |
| Experiment | `007-aia-schd-soybean-max-sharpe-2015_11` |
...
Evaluate the eight-asset TOBE portfolio from 2015-11 through 2026-08 with KODEX Soybean Futures(H) added at 5% and SCHD reduced to 5%, using Maximum Sharpe optimization.
...
- [Public Report](https://comus93.github.io/portfolio-optimizer-kr/runs/20260914-0001/report.html)
- [Report](report.html)
- [Input](input.yaml)
- [Result](result.json)
