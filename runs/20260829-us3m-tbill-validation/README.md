...
| Optimized Portfolio | AIA 0%, GDX 0%, GLD 30%, QQQ 24.4%, SLV 0%, SPMO 41.08%, XLE 4.52% |

## Key Results

| Portfolio | CAGR | Annualized Return | Expected Return | Standard Deviation | Maximum Drawdown | Sharpe Ratio (ex-post) | Sortino Ratio |
|---|---:|---:|---:|---:|---:|---:|---:|
| provided | 17.40% | 17.48% | 17.48% | 16.48% | -22.48% | 0.917 | 1.558 |
| optimized | 17.65% | 17.21% | 17.21% | 13.10% | -18.31% | 1.132 | 2.002 |
| benchmark | 14.90% | 15.14% | 15.14% | 15.33% | -23.93% | 0.833 | 1.311 |
...
- [Public Report](https://comus93.github.io/portfolio-optimizer-kr/runs/20260829-us3m-tbill-validation/report.html)
- [Report](report.html)
- [Input](input.yaml)
- [Result](result.json)
- [Raw tables](raw/)
