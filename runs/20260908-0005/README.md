# 005-direct-proxy-max-return-vol11

## Metadata

| Field | Value |
|---|---|
| Run ID | `20260908-0005` |
| Product | Optimization |
| Study | `kaw-target-reconstruction` |
| Experiment | `005-direct-proxy-max-return-vol11` |
...
| Optimized Portfolio | 069500 6.94%, 101280 0%, 132030 40.6%, 133690 24.65%, 168580 0%, 200250 0%, 385560 0%, 402970 27.81%, TLT 0% |
...
| optimized | 18.20% | 17.43% | 17.43% | 11.00% | -10.86% | 1.235 | 2.212 |
...
- [Public Report](https://comus93.github.io/portfolio-optimizer-kr/runs/20260908-0005/report.html)
- [Report](report.html)
- [Input](input.yaml)
- [Result](result.json)
