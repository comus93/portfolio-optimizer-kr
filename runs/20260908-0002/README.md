# 002-direct-proxy-max-sharpe

## Metadata

| Field | Value |
|---|---|
| Run ID | `20260908-0002` |
| Product | Optimization |
| Study | `kaw-target-reconstruction` |
| Experiment | `002-direct-proxy-max-sharpe` |
...
| Optimized Portfolio | 069500 0%, 101280 14%, 132030 36.57%, 133690 17.04%, 168580 0%, 200250 0%, 385560 0%, 402970 32.39%, TLT 0% |
...
- [Public Report](https://comus93.github.io/portfolio-optimizer-kr/runs/20260908-0002/report.html)
- [Report](report.html)
- [Input](input.yaml)
- [Result](result.json)
