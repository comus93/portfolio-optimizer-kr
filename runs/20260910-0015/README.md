# 009-direct-proxy-max-return-vol11_5

## Metadata

| Field | Value |
|---|---|
| Run ID | `20260910-0015` |
| Product | Optimization |
| Study | `kaw-target-reconstruction` |
| Experiment | `009-direct-proxy-max-return-vol11_5` |
...
|---|---|
| Provided Portfolio | 069500 8%, 101280 5%, 132030 20%, 133690 10%, 168580 8.5%, 200250 8.5%, 385560 15%, 402970 10%, TLT 15% |
| Optimized Portfolio | 069500 9%, 101280 0%, 132030 40.74%, 133690 25.31%, 168580 0%, 200250 0%, 385560 0%, 402970 24.95%, TLT 0% |

## Key Results

| Portfolio | CAGR | Annualized Return | Expected Return | Standard Deviation | Maximum Drawdown | Sharpe Ratio (ex-post) | Sortino Ratio |
|---|---:|---:|---:|---:|---:|---:|---:|
| provided | 8.60% | 8.77% | 8.77% | 9.95% | -15.78% | 0.495 | 0.736 |
| optimized | 18.57% | 17.80% | 17.80% | 11.50% | -11.40% | 1.214 | 2.169 |
...
- [Public Report](https://comus93.github.io/portfolio-optimizer-kr/runs/20260910-0015/report.html)
- [Report](report.html)
- [Input](input.yaml)
- [Result](result.json)
